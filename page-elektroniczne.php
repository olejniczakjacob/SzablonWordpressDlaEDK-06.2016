<?php
/*Template name: Projekty elektroniczne*/
?>
...
<?php get_header(); ?>
			<div id="content">
				<div id="articles">
					...
					<div class="clr"></div>
					<?php $nameofkat = $post->post_name; query_posts('category_name=projekty_elektroniczne&post_status=publish,future&showposts=50'); while (have_posts()) : the_post();?>
						<div class="ok">	
							<article>
								<header>
									<div class="image">
